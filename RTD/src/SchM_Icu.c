...
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_60[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_60[NUMBER_OF_CORES];
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_61[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_61[NUMBER_OF_CORES];
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_62[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_62[NUMBER_OF_CORES];
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_63[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_63[NUMBER_OF_CORES];
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_64[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_64[NUMBER_OF_CORES];
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_65[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_65[NUMBER_OF_CORES];
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_66[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_66[NUMBER_OF_CORES];
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_67[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_67[NUMBER_OF_CORES];
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_68[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_68[NUMBER_OF_CORES];
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_69[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_69[NUMBER_OF_CORES];
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_70[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_70[NUMBER_OF_CORES];
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_71[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_71[NUMBER_OF_CORES];
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_72[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_72[NUMBER_OF_CORES];
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_73[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_73[NUMBER_OF_CORES];
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_74[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_74[NUMBER_OF_CORES];
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_75[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_75[NUMBER_OF_CORES];
static volatile uint32 msr_ICU_EXCLUSIVE_AREA_76[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_ICU_EXCLUSIVE_AREA_76[NUMBER_OF_CORES];
