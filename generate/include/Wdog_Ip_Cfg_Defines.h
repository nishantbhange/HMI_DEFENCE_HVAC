...
#define WDOG_IP_CFG_DEFINES_SW_MAJOR_VERSION             3
...
==================================================================================================*/
    ...
    #error "AutoSar Version Numbers of Wdog_Ip_Cfg_Defines.h and Std_Types.h are different"
    #endif
...
/**
* @brief  Enable available Wdog instances on platform
*/
...
/**
* @brief  Define a certain timeout value from OsIf which will be used in the driver.
*/
